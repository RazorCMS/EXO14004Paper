...
region. Statistical fluctuations on the 2$\mu$ control
region data are propagated to the background estimation which results
in large uncertainties especially at high values of MR and
RSQ. Additionally, differences in modeling of the recoil spectra between $\PW$+jets and $\cPZ$+jets processes, as well as
the cross section uncertainties could affect the aggrement of this crosscheck.
